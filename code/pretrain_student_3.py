...
def setup_and_train(is_ablation=False):
    ...
    student_config = BertConfig.from_pretrained("bert-base-uncased", num_hidden_layers=3)               
    ...
    output_dir = "./distilbert-pretraining-ablation-3-layer" if is_ablation else "./distilbert-pretraining-3-layer"
    ...
    save_path = "./distilbert-student-pretrained-ablation-3-layer" if is_ablation else "./distilbert-student-pretrained-3-layer"
